"""added text identityand non nullable

Revision ID: 759f1f113353
Revises: ccb05accdc48
Create Date: 2021-05-05 09:56:09.546137
...
revision = '759f1f113353'
down_revision = 'ccb05accdc48'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    sa.Column('spotifyLink', sa.String(length=256), nullable=False),
